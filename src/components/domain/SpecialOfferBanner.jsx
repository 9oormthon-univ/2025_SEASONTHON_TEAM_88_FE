...
const SpecialOfferBanner = () => {
  return (
    <section className="p-4 bg-white">
      <h2 className="mb-3 font-sans text-lg font-bold">특별한 날엔, 특별한 상품</h2>
      <div className="relative w-full overflow-hidden rounded-2xl">
        ...
        <div className="absolute flex items-center gap-1 text-white bottom-4 right-4">
          <button className="text-[0.625rem] font-semibold bg-[#464B51]/40 px-3 py-1.5 rounded-full font-sans flex items-center gap-1">
